...
urlpatterns = [
    ...
    path("editarInventario/<int:inventario_id>/", views.editarInventario, name="editarInventario"),
    path("eliminarInventario/<int:inventario_id>/", views.eliminarInventario, name="eliminarInventario"),
