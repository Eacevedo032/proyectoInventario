function updateFechaUso(selectElement) { 
    ...
    if (fechaReserva) { 
        // Convertir fecha en formato "dd de mes de yyyy" a "yyyy-MM-dd" 
         ...
         if (match) { const dia = match[1]; 
            ...
            const formattedDate = `${anio}-${mes}-${dia.padStart(2, '0')}`;
             ...
             document.addEventListener('DOMContentLoaded', () => {
                ...
                document.getElementById('subcategoria').addEventListener('change', actualizarItems);
            });
            ...
            function actualizarSubcategorias() {
                ...
                // Realizar la solicitud para obtener las subcategorías basadas en la categoría seleccionada
            ...
            function actualizarItems() {
                ...
                // Verificar si tanto la categoría como la subcategoría están seleccionadas
                ...
                // Realizar la solicitud para obtener los ítems basados en la categoría y subcategoría seleccionada
